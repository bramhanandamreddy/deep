(self.webpackChunkhttp_workbench=self.webpackChunkhttp_workbench||[]).push([[7451,4489],{43641:(e,t,r)=>{"use strict";r.d(t,{G0:()=>o,Pn:()=>i,jx:()=>n});var a=r(54302),s=r(47069);async function o(){return localStorage.getItem(`${window.USER_ID}:workbench-layout`)||s.N}async function n(e){localStorage.setItem(`${window.USER_ID}:workbench-layout`,e),a.VSCodeCommunicationsService.postMessageToExtension({type:"SET_WORKBENCH_LAYOUT",payload:e})}function i(e){return a.VSCodeCommunicationsService.subscribe("SET_WORKBENCH_LAYOUT",(t=>{localStorage.setItem(`${window.USER_ID}:workbench-layout`,t),e(t)}))}},25883:(e,t,r)=>{"use strict";r.d(t,{Z:()=>l}),r(40540);var a=r(25892),s=r.n(a),o=r(52322);let n;const i=s().div(n||(n=(e=>e)`
  display: inline-flex;
...
`)),q="http",R="ws-raw",P="grpc";var Z=r(15837),A=r(52322);let D,L,z,_,B,O=e=>e;const F=c().div(D||(D=O`
  height: 24px;
  width: 24px;
  box-sizing: border-box;
`)),N=c()(p.Z)(L||(L=O`
...
`)),pn=(0,o.observer)((()=>{const[e]=Es(),t=e.length>0?(0,A.jsxs)(hn,{children:["(",e.length,")"]}):null;return(0,A.jsxs)("div",{children:["Headers",t]})}));pn.displayName="observer(RequestHeadersTabHeader)";const mn=pn;var gn=r(70906);const vn=()=>{const e=(0,f.x)();return[e.activeRequestEditorTabIndex,e.setActiveRequestEditorTabIndex]};let bn,fn,yn,xn,kn,Sn=e=>e;const wn=c()(l.PaneContent)(bn||(bn=Sn`
  box-sizing: border-box;
  width: 100%;
  overflow: auto;
`)),jn=c()(ba.Z)(fn||(fn=Sn`
