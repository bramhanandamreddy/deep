"use strict";(self.webpackChunkws_workbench=self.webpackChunkws_workbench||[]).push([[7623],{17623:(e,l,n)=>{n.r(l),n.d(l,{FileUploader:()=>Fe,KeyValueEditor:()=>mn});var i=n(7560),t=n(40540),o=n(25892),s=n.n(o),a=n(62932),r=n(50916),d=n(98283),c=n(64382),u=n(22723),h=n.n(u),p=n(53723),b=n.n(p),v=n(65848),g=n(52322);let f,m,x=e=>e;const y=s().div(f||(f=x`
  position: relative;
  display: flex;
...
`),(({isFocused:e})=>e&&"\n        border: var(--border-width-default) var(--border-style-solid) var(--border-color-default);\n        background: var(--background-color-primary);\n        height: var(--size-s);\n        padding-left: var(--spacing-xs);\n        margin-top: var(--spacing-xs);\n        margin-right: var(--spacing-s);\n    "));function ie(e){const{value:l,isEditable:n,onBlur:i,onChange:t,onFocus:o,type:s}=e,a=`${s} masked cell`;return(0,g.jsx)(ne,{isFocused:Boolean(n),onBlur:i,onClick:o,onFocus:o,children:(0,g.jsx)("input",{role:"cell","aria-label":a,value:l||"",spellCheck:!1,type:"password",onChange:e=>{t(e.currentTarget.value)}},"text")})}var te=n(16913),oe=n(81397),se=n(79233);const ae=["hidden","value","isEditable","currentWidth","readOnly","shouldFocusOnMount","onBlur","onChange","onFocus","actions","editorType","maskState","enableVariableSuggestions","placeholder","isDuplicated"];let re;const de=s()(te.Z)(re||(re=(e=>e)`
  position: absolute;
  align-self: center;
  right: var(--spacing-s);
  z-index: 10;
...
`));function He(e){const{id:l,type:n,value:i,hidden:o,error:s,onFilesSelect:a,onChange:r}=e,[d,c]=(0,t.useState)(!1),u=ze(),h=(0,t.useMemo)((()=>Array.isArray(i)?i:i?[i]:[]),[i]);return o?null:(0,g.jsx)(Be,{height:"100%",width:"100%",children:(0,g.jsx)(Fe,{label:Ne,id:"key-value-file-uploader",multiple:!0,error:s,value:h,loading:d,onChange:e=>{a&&(c(!0),a(l,e).finally((()=>{u.current&&c(!1)})))},onReset:()=>null==r?void 0:r(n,"")})})}const Le=e=>e.disableEdit,Ke=(e,l)=>l||e.system&&!e.allowedToToggle,Ie=(e,l)=>!e.disableEdit&&!(null!=l&&l.disableToggle)||e.system;var _e=n(70262),Ue=n(95362);let Xe;const Ye=s().div(Xe||(Xe=(e=>e)`
